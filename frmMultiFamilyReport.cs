...
{
    public partial class frmMultiFamilyReport : Form
    {
        ...
        public frmMultiFamilyReport(string activeUserFullName, string auditID, string companyNameOverride, string contactNameOverride, string energyAdvisorNameOverride, string energyAdvisorPhone, string energyAdvisorEmail, string topRecommendation, List<string> filters, bool fromSignOffTab, Company.CompanyCollection coList, string filePath, ClientMultifamilyReportBranding reportBranding)
        {
            InitializeComponent();
        ...
        private void ApplyBranding(ClientMultifamilyReportBranding b)
        {
            ...
            try
            {
                ...
                SetTableHeader(subDI.Subreport.Fields["ThermsLbl"], b);
                ...
                SetTableHeader(subUnitDI.Subreport.Fields["ThermsLbl"], b);
                ...
                SetTableHeader(subRec.Subreport.Fields["lblQuantity"], b);
                SetTableHeader(subRec.Subreport.Fields["lblAnnualSavings"], b);
                SetTableHeader(subRec.Subreport.Fields["lblKwh"], b);
                SetTableHeader(subRec.Subreport.Fields["lblMcf"], b);
                SetTableHeader(subRec.Subreport.Fields["lblCost"], b);
                SetTableHeader(subRec.Subreport.Fields["lblEstimatedIncentive"], b);
                SetColor(subRec.Subreport.Fields["RecommendationsReportRank"], b.RetrofitTotalBackColor, "");
                SetColor(subRec.Subreport.Fields["RecommendationsSumBackground"], b.RetrofitTotalBackColor, "");
        ...
        private void frmMultiFamilyReport_Load(object sender, EventArgs e)
        {
        ...
        private void CreateReportXml()
        {
            ...
            if (ReportBranding.HideKwh && !this.IsTableAdjusted)
            {
                ...
                rptDI.Subreport.Fields["lblTotalKwhSavings"].Visible = false;
                ...
                rptDI.Subreport.Fields["lblTotalMcfSavings"].Top = rptDI.Subreport.Fields["fldCostSavingsSum"].Top;
                rptDI.Subreport.Fields["fldMcfSum"].Top = rptDI.Subreport.Fields["fldCostSavingsSum"].Top;

                rptRec.Subreport.Fields["lblKwh"].Visible = false;
                rptRec.Subreport.Fields["fldKwh"].Visible = false;
                rptRec.Subreport.Fields["lblAnnualKwhSavings"].Visible = false;
                rptRec.Subreport.Fields["fldSumAnnualKwh"].Visible = false;
                ...
                rptRec.Subreport.Fields["lblAnnualMcfSavings"].Top = rptRec.Subreport.Fields["fldSumAnnualCost"].Top;
                rptRec.Subreport.Fields["fldSumAnnualMcf"].Top = rptRec.Subreport.Fields["fldSumAnnualCost"].Top;
            ...
            if (ReportBranding.HideMCF && !this.IsTableAdjusted)
            {
                ...
                rptDI.Subreport.Fields["lblTotalMcfSavings"].Visible = false;
                ...
                rptDI.Subreport.Fields["lblTotalKwhSavings"].Top = rptDI.Subreport.Fields["fldCostSavingsSum"].Top;
                rptDI.Subreport.Fields["fldKwhSum"].Top = rptDI.Subreport.Fields["fldCostSavingsSum"].Top;

                rptRec.Subreport.Fields["lblMcf"].Visible = false;
                rptRec.Subreport.Fields["fldMcf"].Visible = false;
                rptRec.Subreport.Fields["lblAnnualMcfSavings"].Visible = false;
                rptRec.Subreport.Fields["fldSumAnnualMcf"].Visible = false;
                ...
                rptRec.Subreport.Fields["lblAnnualKwhSavings"].Top = rptRec.Subreport.Fields["fldSumAnnualCost"].Top;
                rptRec.Subreport.Fields["fldSumAnnualKwh"].Top = rptRec.Subreport.Fields["fldSumAnnualCost"].Top;
